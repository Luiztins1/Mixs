package com.github.Luiztins1.mixs.controller.common;

import com.github.Luiztins1.mixs.controller.dto.FieldErrorResponseDTO;
import com.github.Luiztins1.mixs.controller.dto.ResponseErrorDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseErrorDTO methodArgumentNotValidException (MethodArgumentNotValidException e){
        List<FieldErrorResponseDTO> fieldErrorDTOList =
                e.getBindingResult()
                        .getFieldErrors()
                        .stream()
